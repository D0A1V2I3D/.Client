...
import top.davidon.ironware.events.EventGameLoop;
import top.davidon.ironware.events.EventKey;
import top.davidon.ironware.events.EventTick;
import top.davidon.ironware.modules.player.FastPlace;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        {
            this.displayGuiScreen(new GuiConnecting(new Menu(), this, this.serverName, this.serverPort));
        }
        else
        {
            this.displayGuiScreen(new Menu());
        }
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        Display.setTitle("Loading " + Client.getName());
    ...
    public void displayGuiScreen(GuiScreen guiScreenIn)
    {
        ...
        if (guiScreenIn instanceof Menu)
        {
    ...
    {
        EventManager.call(new EventGameLoop());
        ...
        if (this.leftClickCounter <= 0)
        {
            ...
            else
            {
                switch (this.objectMouseOver.typeOfHit)
                {
                    ...
                    case MISS:
                    default:
                        if (this.playerController.isNotCreative() && !Client.moduleManager.getModuleByName("NoMissDelay").get().getEnabled())
                        {
                            this.leftClickCounter = 10;
                        }
                }
    ...
    private void rightClickMouse()
    {
        ...
        {
            FastPlace fp = (FastPlace) Client.moduleManager.getModuleByName("FastPlace").get();
            if (fp.getEnabled()) {
                this.rightClickDelayTimer = fp.getDelay().get().intValue();
            } else {
