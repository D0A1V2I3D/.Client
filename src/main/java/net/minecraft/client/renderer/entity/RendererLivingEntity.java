...
import top.davidon.ironware.events.EventNameTags;
...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T>
{
    ...
    public void renderName(T entity, double x, double y, double z)
    {
        ...
        {
            EventNameTags eventNameTags = new EventNameTags(entity);
            EventManager.call(eventNameTags);

            if (eventNameTags.isCancelled()) return;
