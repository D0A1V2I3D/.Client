...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    public void updateCameraAndRender(float partialTicks, long nanoTime)
    {
        ...
        EventManager.call(new EventRender(partialTicks,
                scaledResolution, Mouse.getX() * scaledResolution.getScaledWidth() / mc.displayWidth, scaledResolution.getScaledHeight() - Mouse.getY() *
                scaledResolution.getScaledHeight() / mc.displayHeight - 1, EventRender.Type.FRAME));
        ...
        if (!this.mc.skipRenderWorld)
        {
            ...
            EventManager.call(new EventRender(partialTicks,
                    scaledResolution, Mouse.getX() * scaledResolution.getScaledWidth() / mc.displayWidth, scaledResolution.getScaledHeight() - Mouse.getY() *
                    scaledResolution.getScaledHeight() / mc.displayHeight - 1, EventRender.Type.RENDER_SCREEN));
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano)
    {
        ...
        EventManager.call(new EventRender(partialTicks,
                scaledResolution, Mouse.getX() * scaledResolution.getScaledWidth() / mc.displayWidth, scaledResolution.getScaledHeight() - Mouse.getY() *
                scaledResolution.getScaledHeight() / mc.displayHeight - 1, EventRender.Type.RENDER_3D));
    ...
    private void frameInit()
    {
        ...
        {
            this.updateMainMenu((Menu)this.mc.currentScreen);
        }
    ...
    private void updateMainMenu(Menu p_updateMainMenu_1_)
    {
        try
        {
            String s = null;
