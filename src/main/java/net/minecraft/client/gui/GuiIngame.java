...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        EventManager.call(new EventRender(partialTicks,
                ...
                scaledresolution.getScaledHeight() / mc.displayHeight - 1, EventRender.Type.RENDER_2D));
        ...
        {
            EventCrosshair eventCrosshair = new EventCrosshair(EventType.PRE, scaledresolution);
            ...
            EventCrosshair eventCrosshair1 = new EventCrosshair(EventType.POST, scaledresolution);
            EventManager.call(eventCrosshair1);
        }
        ...
        EventManager.call(new EventDraw());
